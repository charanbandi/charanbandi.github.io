...
const ScrollStack: React.FC<ScrollStackProps> = ({
  ...
  useLayoutEffect(() => {
    ...
    if (useWindowScroll) {
      // Use native scroll events — the app's existing Lenis fires these natively,
      // so we don't need a second Lenis instance.
    ...
    onStackComplete, handleScroll, updateCardTransforms,
  ]);
